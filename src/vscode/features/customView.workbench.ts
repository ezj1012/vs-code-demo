...
import { ViewContainerLocation, ConfirmResult } from '../emumHepler'
...
registerCustomView({
  ...
  location: ViewContainerLocation.Panel.valueOf(),
...
class CustomEditorInput extends SimpleEditorInput implements IEditorCloseHandler {
  ...
  async confirm(): Promise<number> {
    ...
    return confirmed ? ConfirmResult.DONT_SAVE.valueOf() : ConfirmResult.CANCEL.valueOf()
  }

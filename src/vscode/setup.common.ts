...
import { type IWorkbenchConstructionOptions, LogLevel, type IEditorOverrideServices } from 'vscode/services'
...
console.log(`useHtmlFileSystemProvider : ${useHtmlFileSystemProvider}`)
